"""Build the estimator metric tables (Table_LSE_1, Table_LSE_2)."""
import argparse
import json
import sys
...
from v2.lse.summarize import estimator_metrics  # noqa: E402
...
def main():
    ...
    print(json.dumps(estimator_metrics(root, Path(args.out).resolve(), raw=raw)))
